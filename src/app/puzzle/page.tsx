        ...
        <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-8 py-20">
          <div className={`text-center mb-12 ${mounted ? 'animate-fade-up' : 'opacity-0'}`}>
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-display mb-4">
              {t('puzzle.title').split('龙虾')[0]}<span className="text-[#ff6b6b]">龙虾</span>{t('puzzle.title').split('龙虾')[1]}
            </h1>
          ...
          <div className="flex items-center justify-between w-full max-w-2xl mt-12">
            ...
            <Link 
              href="/capabilities"
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-[#ff6b6b] to-[#ffa502] text-white font-medium shadow-lg hover:shadow-xl transition-all"
            >
