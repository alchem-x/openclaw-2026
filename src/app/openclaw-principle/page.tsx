...
import piAgentLoopImg from '@/assets/pi-agent-loop.jpg'
...
export default function OpenclawPrinciple() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-md' : ''}`}
      >
      ...
      <div className="min-h-screen bg-[#fff9f5] wave-bg">
        <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-8 pt-32 pb-20">
          <div className={`text-center mb-12 ${mounted ? 'animate-fade-up' : 'opacity-0'}`}>
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-display mb-4 text-black">{t('principle.title')}</h1>
            <p className="text-xl text-[#636e72] max-w-xl mx-auto">{t('principle.subtitle')}</p>
          </div>

          <div
            className={`w-full max-w-4xl ${mounted ? 'animate-fade-up' : 'opacity-0'}`}
                ...
                sections.map(
                  (
                    section: {
                      ...
                      desc: string
                      color: string
                      components?: { label: string; items: { name: string; desc: string }[] }
                    },
                    index: number,
                  ) => (
                    <div
                    ...
                    >
                      <div className="flex items-start p-6 gap-5">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[#636e72] leading-relaxed pl-6">{section.desc}</p>
                          {section.components && (
                              ...
                              <ul className="space-y-2">
                                {section.components.items.map((component, idx) => (
                                  <li key={idx} className="flex items-start gap-3 group">
                                    <div
                                      className="flex-shrink-0 w-2 h-2 rounded-full mt-2 transition-all"
                                      style={{ backgroundColor: section.color }}
                                    />
                            ...
                            <div className="mt-6 pl-6 space-y-6">
                              ...
                              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-6 rounded-xl border-2 border-emerald-200">
                                <div className="mb-4">
                                  <h4 className="text-xl font-bold text-black">
                                    {t('principle.architecture.philosophy.title')}
                                  </h4>
                                </div>
                                ...
                                <div className="bg-white/60 backdrop-blur p-4 rounded-lg border border-emerald-200">
                                  <p className="text-sm text-gray-600 italic">
                                    ...
                                    <span className="font-semibold text-emerald-700">
                                      {' '}
                                      — {t('principle.architecture.philosophy.author')}
                                    </span>
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-200">
                                <h4 className="text-lg font-bold text-black mb-4">
                                  {t('principle.architecture.paradigm.title')}
                                </h4>
                                    ...
                                    <thead>
                                      <tr className="border-b-2 border-blue-300">
                                        <th className="text-left p-3 font-bold text-black">
                                          {t('principle.architecture.paradigm.tableHeaders.dimension')}
                                        </th>
                                        <th className="text-left p-3 font-bold text-black">
                                          {t('principle.architecture.paradigm.tableHeaders.traditional')}
                                        </th>
                                        <th className="text-left p-3 font-bold text-blue-700">
                                          {t('principle.architecture.paradigm.tableHeaders.new')}
                                        </th>
                                      </tr>
                                    </thead>
                                    <tbody className="text-gray-700">
                                      <tr className="border-b border-blue-200 bg-white/50">
                                        <td className="p-3 font-semibold">
                                          {t('principle.architecture.paradigm.dimensions.flexibility')}
                                        </td>
                                        <td className="p-3">
                                          {t('principle.architecture.paradigm.traditional.flexibility')}
                                        </td>
                                        <td className="p-3 text-blue-700 font-semibold">
                                          {t('principle.architecture.paradigm.newParadigm.flexibility')}
                                        </td>
                                      </tr>
                                      <tr className="border-b border-blue-200">
                                        <td className="p-3 font-semibold">
                                          {t('principle.architecture.paradigm.dimensions.security')}
                                        </td>
                                        <td className="p-3">
                                          {t('principle.architecture.paradigm.traditional.security')}
                                        </td>
                                        <td className="p-3 text-blue-700 font-semibold">
                                          {t('principle.architecture.paradigm.newParadigm.security')}
                                        </td>
                                      </tr>
                                      <tr className="bg-white/50">
                                        <td className="p-3 font-semibold">
                                          {t('principle.architecture.paradigm.dimensions.efficiency')}
                                        </td>
                                        <td className="p-3">
                                          {t('principle.architecture.paradigm.traditional.efficiency')}
                                        </td>
                                        <td className="p-3 text-blue-700 font-semibold">
                                          {t('principle.architecture.paradigm.newParadigm.efficiency')}
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <div>
                                <h4 className="text-lg font-bold text-black mb-3">
                                  {t('principle.architecture.diagram')}
                                </h4>
                                <div
                          ...
                          {index === 1 && (
                            <div className="mt-6 pl-6 space-y-6">
                              ...
                              <div>
                                <h4 className="text-lg font-bold text-black mb-3">
                                  {t('principle.agentLoop.pseudocode')}
                                </h4>
  ...
  if (response.isDone()) break
                              ...
                              <div>
                                <h4 className="text-lg font-bold text-black mb-3">
                                  {t('principle.agentLoop.simpleDiagram')}
                                </h4>
                                <div
                              ...
                              <div>
                                <h4 className="text-lg font-bold text-black mb-3">
                                  {t('principle.agentLoop.completeDiagram')}
                                </h4>
                                <div
                                  className="relative w-full rounded-lg overflow-hidden border border-gray-200 cursor-pointer hover:opacity-90 transition-opacity bg-white"
                                  onClick={(e) => {
                                    e.stopPropagation()
                                    setPreviewImage(piAgentLoopImg)
                                  }}
                                >
                                  <Image
                                    src={piAgentLoopImg}
                              ...
                              <div className="bg-gradient-to-br from-violet-50 to-purple-50 p-6 rounded-xl border border-violet-200">
                                <div className="flex items-start gap-4">
                                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-violet-500 flex items-center justify-center shadow-md">
                                  ...
                                  <div className="flex-1">
                                    <h4 className="text-lg font-bold text-black mb-2">
                                      {t('principle.agentLoop.readMore')}
                                    </h4>
                                    <p className="text-gray-600 mb-4">
                                      {t('principle.agentLoop.readMoreDesc')}
                                    </p>
                                    <a
                                      href="https://learn-claude-agents.vercel.app/"
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center gap-2 px-4 py-2 bg-violet-500 hover:bg-violet-600 text-white rounded-lg transition-colors font-medium"
                                    >
                                      <span>Learn Claude Agents</span>
